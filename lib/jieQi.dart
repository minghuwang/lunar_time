class JieQi {
  ...
  //Calc the JieQi from solar date
  ...
  int getJieQiStartDay(int solarYear, int solarMonth) {
    ...
    // 调整
    //立夏1911年的计算结果加1日。
    if (solarYear == 1911 && solarMonth == 5) {
      //1911,立夏
      day++;
    }

    // 芒种例外：1902年的计算结果加1日。
    if (solarYear == 1902 && solarMonth == 6) {
      //芒种
      day++;
    }
    if ((solarYear == 2016 || solarYear == 1925) && solarMonth == 7) {
      //1925 or 2016,小暑
      day++;
    }
    if (solarYear == 2002 && solarMonth == 8) {
      //2002,立秋
      day++;
    }
    // 白露1927年的计算结果加1日
    if (solarYear == 1927 && solarMonth == 9) {
      //白露
      day++;
    }
    if (solarYear == 2089 && solarMonth == 11) {
      //2089,立冬
      day++;
    }
    // 1954年的计算结果加1日
    if (solarYear == 1954 && solarMonth == 12) {
      //大雪
      day++;
    }
    if (solarYear == 2019 && solarMonth == 1) {
      //2019,小寒
      day--;
    }
    // 小寒1982年计算结果加1日
    if (solarYear == 1982 && solarMonth == 1) {
      //小寒
      day--;
    }
    return day;
