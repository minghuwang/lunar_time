...
part 'lunar.dart';
part 'solar.dart';
// usage: https://github.com/isee15/Lunar-Solar-Calendar-Converter/blob/master/Dart/main.dart
/*
...
class LunarSolarConverter {
  ...
  static Lunar solarToLunar(Solar solar) {
    Lunar lunar = Lunar(lunarYear: 0, lunarMonth: 0, lunarDay: 0, isLeap: false);
